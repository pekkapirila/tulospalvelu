...
static wchar_t ctrlkey[25] = {94,95,96,97,98,99,100,101,102,103,
      69,70,119,141,132,74,115,76,116,78,117,145,118,146,147};
static wchar_t altkey[25] = {104,105,106,107,108,109,110,111,112,113,
	...
	*ch2 = 0;
	...
	if (nRead) {
      if (!ProcessSpecialKey(&Buf)) {
         ...
         if (ch == 224)
            ch = 0;
		   *ch2 = Buf.Event.KeyEvent.wVirtualScanCode;
