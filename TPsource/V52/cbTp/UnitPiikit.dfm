object FormPiikit: TFormPiikit
  ...
  object CBRata: TComboBox
    ...
    TabOrder = 2
    Text = 'CBRata'
    OnChange = CBRataChange
  end
  object RGPuoli: TRadioGroup
    Left = 10
    Top = 138
    Width = 91
    Height = 65
    Caption = ' Kortin puoli '
    ItemIndex = 0
    Items.Strings = (
      'Etupuoli'
      'Takapuoli')
    TabOrder = 3
    OnClick = RGPuoliClick
  end
  object Memo1: TMemo
    Left = 8
    Top = 209
