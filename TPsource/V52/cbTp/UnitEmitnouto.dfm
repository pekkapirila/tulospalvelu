object FormEmitNouto: TFormEmitNouto
  Left = 0
  Top = 0
  Caption = 'Sanomien haku Emitin palvelimelta'
  ClientHeight = 223
  ClientWidth = 400
  Color = clBtnFace
  ...
  object CBAvoinna1: TCheckBox
    Left = 21
    Top = 128
    Width = 96
    Height = 17
    Alignment = taLeftJustify
    Caption = 'Nouto avattu'
    TabOrder = 7
    OnClick = CBAvoinna1Click
  end
  ...
  object BtnUusihaku1: TButton
    Left = 21
    Top = 163
    Width = 148
    Height = 21
    Caption = 'Hae uudelleen alusta'
    TabOrder = 12
    WordWrap = True
    OnClick = BtnUusihakuClick
  end
  object EdtLaiteNo1: TEdit
    Left = 103
    Top = 101
    Width = 22
    Height = 21
