object FormSivuTuloste: TFormSivuTuloste
  Left = 0
  Top = 0
  Caption = 'Sivutulosteet'
  ClientHeight = 311
  ClientWidth = 427
  Color = clBtnFace
  ...
  object CBJatkuva: TCheckBox
    ...
    Width = 97
    Height = 17
    Caption = 'Jatkuva tulostus'
    TabOrder = 2
    OnClick = CBJatkuvaClick
  end
  object BtnKirjoita: TButton
    Left = 213
    Top = 32
    Width = 113
    Height = 25
    Caption = 'Kirjoita valitut'
    TabOrder = 3
    OnClick = BtnKirjoitaClick
  end
  object CBValinta: TComboBox
    Left = 216
    Top = 64
    Width = 110
    Height = 21
  ...
  object MainMenu1: TMainMenu
    ...
    object iedosto1: TMenuItem
      Caption = '&Tiedosto'
      object allennatehdytvalinnat1: TMenuItem
        Caption = '&Tallenna tehdyt valinnat'
        OnClick = allennatehdytvalinnat1Click
      end
      object Luevalinnattiedostosta1: TMenuItem
        Caption = '&Lue valinnat tiedostosta'
        OnClick = Luevalinnattiedostosta1Click
      end
