object FormCfg: TFormCfg
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel21: TPanel
        ...
        TabOrder = 6
        TabStop = True
        object CBJoustoViesti: TCheckBox
          Left = 8
          Top = -4
          Width = 209
          Height = 55
          Caption = 
            'Joukkueen j'#228'senet voivat jakaa osuudet joustavasti vaihtaen osal' +
            'istujaa ep'#228's'#228#228'nn'#246'llisin v'#228'lein. '
          TabOrder = 0
          WordWrap = True
        end
        object CBVuorokaudet: TCheckBox
          Left = 8
          Top = 63
          Width = 177
          Height = 36
          Caption = 'Kilpailu kest'#228#228' yli 24 tuntia, vuorokaudet merkit'#228#228'n aikoihin'
          TabOrder = 1
          WordWrap = True
        end
        object CBSailHyl: TCheckBox
          Left = 8
          Top = 110
          Width = 177
          Height = 36
          Caption = 'N'#228'yt'#228' hyl'#228'tyt tuloksissa ajan mukaisessa paikassa'
          TabOrder = 2
          WordWrap = True
        end
        object CBNaytaHaj: TCheckBox
          Left = 8
          Top = 153
          Width = 177
          Height = 19
          Caption = 'Piilota hajontaratojen tunnukset'
          TabOrder = 3
        end
      end
    ...
    object TabSheet3: TTabSheet
      ...
      object RGPiste: TRadioGroup
        ...
        Items.Strings = (
          ...
          'Vuorossa oleva piste'
          'K'#228'yt'#228' tiedostoa lahdepisteet.lst')
        TabOrder = 3
    ...
    object TabSheet4: TTabSheet
      ...
      object RGEmittoiminto: TRadioGroup
        Left = 3
        Top = 1
        Width = 258
        Height = 84
        Caption = ' Emit-toiminto '
        ItemIndex = 0
        Items.Strings = (
          'Ei Emit-tietojen k'#228'sittely'#228
          'Leimantarkastuksen tiedot'
          'Sis'#228#228'nluenta'
          'Vaihto k'#228'yt'#246'n aikana sallittu')
        TabOrder = 0
        TabStop = True
        OnClick = RGEmittoimintoClick
      end
      object Panel7: TPanel
        ...
        object CBJalkiSyotto: TCheckBox
          Left = 8
          Top = 5
          Width = 213
          Height = 17
          Caption = 'Emitkoodi kirjataan leimantarkastuksessa'
          TabOrder = 0
        end
        ...
        object CBLuentaLoki: TCheckBox
          Left = 8
          Top = 40
          Width = 195
          Height = 17
          Caption = 'Kirjoita luentatapahtumat lokiin'
          TabOrder = 2
          Visible = False
        end
    ...
    object TabSheet6: TTabSheet
      ...
      object GroupBox2: TGroupBox
        ...
        Width = 281
        Height = 89
        Caption = ' Ajanoton lis'#228'parametrit ohjelmassa ViestiMaali '
        TabOrder = 5
  ...
  object PopupMenuSan: TPopupMenu
    ...
    object AikaPakota: TMenuItem
      Caption = 'Aikasanoman aika korvaa aiemmin tallennetun'
      OnClick = SanValClick
    end
