...
__published:	// IDE-managed Components
   ...
   TLabel *Label9;
   TLabel *Label10;
   TCheckBox *SeurLstVal;
   TCheckBox *SeurGrVal;
   TCheckBox *TlsLuetVal;
	TMainMenu *MainMenu1;
	TMenuItem *Nytt1;
	TMenuItem *Luekorostustiedot1;
	TMenuItem *Muitaasetuksia1;
	TMenuItem *Kuuluttajarajoitukset1;
   ...
   void __fastcall PeruutaBtnClick(TObject *Sender);
	...
	void __fastcall Kuuluttajarajoitukset1Click(TObject *Sender);
	void __fastcall FormShow(TObject *Sender);
	void __fastcall Maksimikesto1Click(TObject *Sender);
