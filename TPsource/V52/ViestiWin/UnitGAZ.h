...
__published:	// IDE-managed Components
	...
	TMainMenu *MainMenu1;
	TMenuItem *Valinnat1;
	TMenuItem *JaaLEDtaulumyssarakkeisiin1;
	...
	void __fastcall EdRiveja1Exit(TObject *Sender);
	void __fastcall JaaLEDtaulumyssarakkeisiin1Click(TObject *Sender);
private:	// User declarations
	...
	void __fastcall TauluJako(int laite, int plkm, int vlkm);
	void __fastcall TauluKirkkaus(int laite, int val);
	int lahriviCPower(int rno, int rivi, char *teksti);
/*
...
*/
	...
	int nosuus;
	int eronaytto, autokarki[MAXOSUUSLUKU];
	int tkarki[MAXOSUUSLUKU], kviive[MAXOSUUSLUKU];
	int htaulu, tosuus[TAULU_NRIVI], lkmaikana[TAULU_NRIVI];
	UINT16 cpow_w[NREGNLY];
	UINT16 cpow_h[NREGNLY];
public:		// User declarations
	__fastcall TFormGAZ(TComponent* Owner);
	void opentaulu(void);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormGAZ *FormGAZ;
//---------------------------------------------------------------------------
#endif
