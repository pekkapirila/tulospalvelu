object FormKaavaTaul: TFormKaavaTaul
  Left = 0
  Top = 0
  Caption = 'Pistekaavojen kertoimet'
  ClientHeight = 490
  ClientWidth = 933
  Color = clBtnFace
  ...
  object CBSij: TCheckBox
    Left = 360
    Top = 8
    Width = 145
    Height = 17
    Caption = 'N'#228'yt'#228' sijoituskertoimet'
    Checked = True
    State = cbChecked
    TabOrder = 3
    OnClick = CBSijClick
  ...
  object CBTls: TCheckBox
    ...
    Width = 145
    Height = 17
    Caption = 'N'#228'yt'#228' tuloskertoimet'
    Checked = True
    State = cbChecked
    TabOrder = 4
    OnClick = CBTlsClick
