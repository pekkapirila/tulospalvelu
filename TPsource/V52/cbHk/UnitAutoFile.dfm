object FormAutoFile: TFormAutoFile
  ...
  object GBhtml: TGroupBox
    ...
    object Label2: TLabel
      ...
      Width = 263
      Height = 15
      Caption = 'Tiedoston nimi yhteen tiedostoon tulostettaessa'
    end
    object Label3: TLabel
      ...
      Width = 238
      Height = 15
      Caption = 'Sivun nimi yhteen tiedostoon tulostettaessa'
    end
    object Label4: TLabel
      ...
      Width = 253
      Height = 15
      Caption = 'Sivun otsikko yhteen tiedostoon tulostettaessa'
    end
    ...
    object RGVaiheet: TRadioGroup
      ...
      ItemIndex = 0
      Items.Strings = (
        'Vain t'#228'm'#228' vaihe'
        'T'#228'm'#228' vaihe ja yhteistulokset')
      TabOrder = 4
    end
    object RG1html: TRadioGroup
      Left = 8
      Top = 190
      Width = 431
      Height = 49
      Caption = ' Tiedostorakenne  '
      Columns = 2
      ItemIndex = 0
      Items.Strings = (
        'Lopputulokset yhteen tiedostoon (Autofile.lst ei vaikuta)'
        'Autofile.lst:n mukaan tai sarjat omiin tiedostoihinsa')
      TabOrder = 5
      WordWrap = True
    end
  end
  ...
  object BtnOhitavalinnat: TButton
    Left = 624
    Top = 490
    Width = 91
    Height = 46
