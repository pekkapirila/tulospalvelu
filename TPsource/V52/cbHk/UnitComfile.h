...
__published:	// IDE-managed Components
	...
	void __fastcall BtnHaebadgeClick(TObject *Sender);
	void __fastcall CBkytkeClick(TObject *Sender);
	void __fastcall cbufout(TextFl *outtxt, char *cbuf);
...
public:		// User declarations
	...
	void __fastcall HaeRivi(int flg);
