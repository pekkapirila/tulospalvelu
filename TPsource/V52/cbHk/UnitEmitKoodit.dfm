object FormEmitKoodit: TFormEmitKoodit
  Left = 0
  Top = 0
  Caption = 'Emit-koodien sy'#246'tt'#246
  ClientHeight = 385
  ClientWidth = 644
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 144
    Height = 13
    Caption = 'Vaiheet, joita merkint'#228' koskee'
  end
  ...
  object CBVaiheet: TComboBox
    ...
    TabOrder = 4
    TabStop = False
    Text = 'T'#228'm'#228' ja my'#246'hemm'#228't vaiheet'
    Items.Strings = (
      'T'#228'm'#228' ja my'#246'hemm'#228't vaiheet'
  ...
  object RGBadge: TRadioGroup
    ...
    Width = 158
    Height = 57
    Caption = ' K'#228'sitelt'#228'v'#228' koodi '
    ItemIndex = 0
    Items.Strings = (
      'Ensisijainen koodi'
      'Toinen koodi')
  ...
  object RGLaina: TRadioGroup
    Left = 464
    Top = 145
    Width = 158
    Height = 72
    Caption = ' Lainakorttimerkint'#228' '
    ItemIndex = 0
    Items.Strings = (
      'J'#228't'#228' ennalleen'
      'Merkitse lainakortiksi'
      'Poista lainakorttimerkinn'#228't')
    TabOrder = 7
  end
end
