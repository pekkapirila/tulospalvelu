object FormAikaSiirto: TFormAikaSiirto
  Left = 0
  Top = 0
  Caption = 'L'#228'ht'#246'aikojen, numeroiden ja vaiheen siirto'
  ClientHeight = 603
  ClientWidth = 539
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 86
    Height = 15
    Caption = 'Siirrett'#228'v'#228' vaihe'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Arial'
  ...
  object Label3: TLabel
    ...
    Width = 126
    Height = 15
    Caption = 'Siirto (aika sekunteina)'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Arial'
  ...
  object RGKohde: TRadioGroup
    ...
    Font.Style = []
    Items.Strings = (
      'Siirr'#228' arvottuja l'#228'ht'#246'aikoja'
      'Aseta l'#228'ht'#246'aika'
      'Siirr'#228' l'#228'ht'#246'portin aikoja'
      'Toteutunut l'#228'ht'#246'aika arvotuksi'
      'Muuta tuloksia'
      'Siirr'#228' kilpailunumeroita'
      'Kaikki tiedot vaiheesta toiseen')
    ParentFont = False
    TabOrder = 6
    OnClick = RGKohdeClick
  end
  object CBVaiheet: TComboBox
    Left = 32
    Top = 246
    Width = 145
    Height = 23
  ...
  object RGTulos: TRadioGroup
    Left = 24
    Top = 277
    Width = 169
    Height = 68
    Caption = ' Tulokset muutoksessa '
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Arial'
    ...
    ItemIndex = 1
    Items.Strings = (
      'Tulokset s'#228'ilyv'#228't'
      'Maaliajat s'#228'ilyv'#228't')
    ParentFont = False
    TabOrder = 11
  end
  object CBKohdeVaihe: TComboBox
    Left = 32
    Top = 370
    Width = 145
    Height = 23
